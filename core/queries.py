...
INTENT_TO_QUERY: dict[Intent, str] = {
    ...
    # 细分意图（精准度优化 Step 1）：专用查询留待后续阶段，先指向通用查询
    Intent.DIAGNOSIS_INQUIRY: GENERAL_QUERY,
    Intent.SYMPTOM_FEATURE: GENERAL_QUERY,
    Intent.DIAGNOSTIC_TEST: GENERAL_QUERY,
    Intent.RISK_FACTORS: GENERAL_QUERY,
    Intent.DIFFERENTIAL_DIAGNOSIS: GENERAL_QUERY,
    Intent.DRUG_INFO: GENERAL_QUERY,
}
